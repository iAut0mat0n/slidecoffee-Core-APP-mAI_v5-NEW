-- SlideCoffee v2 Database Schema with Stripe Billing Support
-- Run this in Supabase SQL Editor (https://app.supabase.com)
--
-- IMPORTANT: Run this script in your Supabase project's SQL Editor
-- This will create all necessary tables for SlideCoffee including Stripe billing support
