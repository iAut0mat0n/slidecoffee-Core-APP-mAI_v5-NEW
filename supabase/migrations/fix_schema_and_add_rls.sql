-- ============================================================================
-- SLIDECOFFEE: Fix Production Schema + Add RLS
-- Safely updates existing tables and adds missing ones
-- ============================================================================
...
-- ============================================================================
-- STEP 1: Fix existing v2_presentations table
-- ============================================================================

-- Add missing columns to v2_presentations
...
-- Add unique constraint for share_token if not exists
DO $$ BEGIN
...
-- ============================================================================
-- STEP 2: Create v2_workspace_members (critical for RLS)
-- ============================================================================
...
DO $$ BEGIN
    ALTER TABLE v2_workspace_members ADD CONSTRAINT v2_workspace_members_pkey PRIMARY KEY (id);
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

DO $$ BEGIN
    ALTER TABLE v2_workspace_members ADD CONSTRAINT v2_workspace_members_workspace_id_user_id_key UNIQUE (workspace_id, user_id);
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

DO $$ BEGIN
    ALTER TABLE v2_workspace_members ADD CONSTRAINT v2_workspace_members_user_id_fkey FOREIGN KEY (user_id) REFERENCES v2_users(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

DO $$ BEGIN
    ALTER TABLE v2_workspace_members ADD CONSTRAINT v2_workspace_members_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES v2_workspaces(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

CREATE INDEX IF NOT EXISTS idx_workspace_members_workspace ON v2_workspace_members USING btree (workspace_id);
CREATE INDEX IF NOT EXISTS idx_workspace_members_user ON v2_workspace_members USING btree (user_id);
...
DO $$ BEGIN
    ALTER TABLE v2_comments ADD CONSTRAINT v2_comments_pkey PRIMARY KEY (id);
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;
...
CREATE INDEX IF NOT EXISTS idx_comments_presentation_id ON v2_comments USING btree (presentation_id);
CREATE INDEX IF NOT EXISTS idx_comments_workspace_id ON v2_comments USING btree (workspace_id);
CREATE INDEX IF NOT EXISTS idx_comments_slide_index ON v2_comments USING btree (slide_index);
CREATE INDEX IF NOT EXISTS idx_comments_parent_id ON v2_comments USING btree (parent_comment_id);
CREATE INDEX IF NOT EXISTS idx_comments_resolved ON v2_comments USING btree (resolved);
...
DO $$ BEGIN
    ALTER TABLE v2_presence ADD CONSTRAINT v2_presence_pkey PRIMARY KEY (id);
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

CREATE INDEX IF NOT EXISTS idx_presence_presentation_id ON v2_presence USING btree (presentation_id);
CREATE INDEX IF NOT EXISTS idx_presence_user_id ON v2_presence USING btree (user_id);
CREATE INDEX IF NOT EXISTS idx_presence_last_seen ON v2_presence USING btree (last_seen_at);
...
DO $$ BEGIN
    ALTER TABLE v2_notifications ADD CONSTRAINT v2_notifications_pkey PRIMARY KEY (id);
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

CREATE INDEX IF NOT EXISTS idx_notifications_user_id ON v2_notifications USING btree (user_id);
CREATE INDEX IF NOT EXISTS idx_notifications_workspace_id ON v2_notifications USING btree (workspace_id);
CREATE INDEX IF NOT EXISTS idx_notifications_read ON v2_notifications USING btree (read);
CREATE INDEX IF NOT EXISTS idx_notifications_created_at ON v2_notifications USING btree (created_at);
...
DO $$ BEGIN
    ALTER TABLE v2_presentation_views ADD CONSTRAINT v2_presentation_views_pkey PRIMARY KEY (id);
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

CREATE INDEX IF NOT EXISTS idx_presentation_views_presentation_id ON v2_presentation_views USING btree (presentation_id);
CREATE INDEX IF NOT EXISTS idx_presentation_views_workspace_id ON v2_presentation_views USING btree (workspace_id);
CREATE INDEX IF NOT EXISTS idx_presentation_views_viewer_type ON v2_presentation_views USING btree (viewer_type);
CREATE INDEX IF NOT EXISTS idx_presentation_views_created_at ON v2_presentation_views USING btree (created_at);
...
DO $$ BEGIN
    ALTER TABLE v2_collaborators ADD CONSTRAINT v2_collaborators_pkey PRIMARY KEY (id);
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

DO $$ BEGIN
    ALTER TABLE v2_collaborators ADD CONSTRAINT v2_collaborators_presentation_id_user_id_key UNIQUE (presentation_id, user_id);
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

CREATE INDEX IF NOT EXISTS idx_collaborators_presentation ON v2_collaborators USING btree (presentation_id);
...
DO $$ BEGIN
    ALTER TABLE v2_folders ADD CONSTRAINT v2_folders_pkey PRIMARY KEY (id);
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

CREATE INDEX IF NOT EXISTS idx_folders_workspace ON v2_folders USING btree (workspace_id);
...
DO $$ BEGIN
    ALTER TABLE v2_analytics ADD CONSTRAINT v2_analytics_pkey PRIMARY KEY (id);
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

CREATE INDEX IF NOT EXISTS idx_analytics_presentation ON v2_analytics USING btree (presentation_id);
...
DO $$ BEGIN
    ALTER TABLE v2_subscriptions ADD CONSTRAINT v2_subscriptions_pkey PRIMARY KEY (id);
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

CREATE INDEX IF NOT EXISTS idx_subscriptions_user ON v2_subscriptions USING btree (user_id);
...
DO $$ BEGIN
    ALTER TABLE v2_credit_transactions ADD CONSTRAINT v2_credit_transactions_pkey PRIMARY KEY (id);
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

CREATE INDEX IF NOT EXISTS idx_credit_transactions_user ON v2_credit_transactions USING btree (user_id);
...
DO $$ BEGIN
    ALTER TABLE v2_presentation_plans ADD CONSTRAINT v2_presentation_plans_pkey PRIMARY KEY (id);
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

CREATE INDEX IF NOT EXISTS idx_presentation_plans_presentation ON v2_presentation_plans USING btree (presentation_id);
...
DO $$ BEGIN
    ALTER TABLE v2_templates ADD CONSTRAINT v2_templates_pkey PRIMARY KEY (id);
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;
...
DO $$ BEGIN
    ALTER TABLE v2_user_context ADD CONSTRAINT v2_user_context_pkey PRIMARY KEY (id);
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

DO $$ BEGIN
    ALTER TABLE v2_user_context ADD CONSTRAINT v2_user_context_user_id_workspace_id_context_type_context_k_key UNIQUE (user_id, workspace_id, context_type, context_key);
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

CREATE INDEX IF NOT EXISTS idx_user_context_user ON v2_user_context USING btree (user_id);
CREATE INDEX IF NOT EXISTS idx_user_context_workspace ON v2_user_context USING btree (workspace_id);
CREATE INDEX IF NOT EXISTS idx_user_context_type ON v2_user_context USING btree (context_type);
CREATE INDEX IF NOT EXISTS idx_user_context_composite ON v2_user_context USING btree (user_id, workspace_id, context_type);
CREATE INDEX IF NOT EXISTS idx_user_context_updated ON v2_user_context USING btree (user_id, updated_at DESC);

-- Add missing table v2_brands if it doesn't exist
CREATE TABLE IF NOT EXISTS v2_brands (
    id uuid DEFAULT uuid_generate_v4() NOT NULL,
    workspace_id uuid,
    name text NOT NULL,
...
DO $$ BEGIN
    ALTER TABLE v2_brands ADD CONSTRAINT v2_brands_pkey PRIMARY KEY (id);
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

CREATE INDEX IF NOT EXISTS idx_brands_workspace ON v2_brands USING btree (workspace_id);

-- ============================================================================
-- STEP 5: Enable RLS on collaboration tables
-- ============================================================================
...
-- ============================================================================
-- MIGRATION COMPLETE!
-- - Fixed v2_presentations schema (added workspace_id and other columns)
-- - Created all missing tables
-- - Applied 12 RLS policies for secure multi-tenant access
-- ============================================================================
